...
import { SHEET_ENDPOINT, SPREADSHEET_ID } from "../config";
...
if (!__entries.length) {
  try {
    const webpackRequire = typeof require !== "undefined" ? require : null;
    if (!webpackRequire?.context) throw new Error("Webpack context is unavailable");
    // Điều chỉnh đường dẫn nếu module này KHÔNG ở src/lib: dùng "../data" thay vì "../../data"
    const ctx = webpackRequire.context(
      "../data",
      true,
